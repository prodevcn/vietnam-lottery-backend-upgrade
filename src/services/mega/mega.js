...
const processNormal = async (order, lottoNumbers) => {
  ...
  matched_count = order_numbers.filter((e) =>
    getAllLot6Numbers(lottoNumbers).includes(e)
  ).length;
  if (matched_count == 0) {
    totalPoints = 0;
  } else {
    totalPoints =
      (2 * matched_count - 1) * winRates.lot6.normal.normal * order.multiple;
  }
  ...
  switch (order.digitType) {
    case 'multiple4':
      ...
      for (let paired_numbers of paired_numbers_arr) {
        let sub_matched_count = paired_numbers.filter((e) =>
          getAllLot6Numbers(lottoNumbers).includes(e)
        ).length;
      ...
      if (matched_count == 0) {
        ...
        totalPoints =
          (2 * matched_count - 1) *
          winRates.lot6.multiple.multiple4 *
          order.multiple;
  ...
  switch (order.digitType) {
    case 'slide5':
      ...
      if (matched_count == 0) {
        ...
        totalPoints =
          (2 * matched_count - 1) * winRates.lot6.slide.slide5 * order.multiple;
        totalPoints = (totalPoints / 22840).toFixed(2);
      }
      await saveHistory(order, totalPoints, matched_count, lottoNumbers);
      return;
    case 'slide6':
      ...
      if (matched_count == 0) {
        ...
        totalPoints =
          (2 * matched_count - 1) * winRates.lot6.slide.slide6 * order.multiple;
        totalPoints = (totalPoints / 22840).toFixed(2);
      }
      await saveHistory(order, totalPoints, matched_count, lottoNumbers);
      return;
    case 'slide7':
      ...
      if (matched_count == 0) {
        ...
        totalPoints =
          (2 * matched_count - 1) * winRates.lot6.slide.slide7 * order.multiple;
        totalPoints = (totalPoints / 22840).toFixed(2);
      }
      await saveHistory(order, totalPoints, matched_count, lottoNumbers);
      return;
    case 'slide8':
      ...
      if (matched_count == 0) {
        ...
        totalPoints =
          (2 * matched_count - 1) * winRates.lot6.slide.slide8 * order.multiple;
        totalPoints = (totalPoints / 22840).toFixed(2);
      }
      await saveHistory(order, totalPoints, matched_count, lottoNumbers);
      return;
    case 'slide9':
      ...
      if (matched_count == 0) {
        ...
        totalPoints =
          (2 * matched_count - 1) * winRates.lot6.slide.slide9 * order.multiple;
        totalPoints = (totalPoints / 22840).toFixed(2);
      }
      await saveHistory(order, totalPoints, matched_count, lottoNumbers);
      return;
...
exports.startMegaLotteryService = async (io) => {
